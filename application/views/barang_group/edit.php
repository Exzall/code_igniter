    ...
    <?php foreach ($data as $dt);?>
        ...
        <form class="userform" method="post" action="<?php echo base_url('index.php/C_barang_group/Update')?>">
            ...
            <div class="ui-grid-a" style="justify-content: center;">
                ...
                <!-- untuk proses hapus masih kurang scriptnya  $dt->id_barang, fungsinya ini utk mengaetahui ID data yang dihapus
                    dan selanjutnya sama fungsi hapus yg ada dicontroller akan ditangkap dengan variabel 
                 $id_barang = $this->uri->segment(3); -->
                <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_barang_group/Hapus/').$dt->id_barang;?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Haspus</a></div><br>
