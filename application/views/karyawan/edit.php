    ...
    <?php foreach ($data as $dt);?>
        ...
        <form class="userform" method="post" action="<?php echo base_url('index.php/C_karyawan/Update')?>">
            ...
            <div class="ui-grid-a" style="justify-content: center;">
                ...
                <div class="ui-block-a"><a href="<?php echo base_url('index.php/C_karyawan/Hapus/').$dt->id;?>" data-rel="close" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-mini">Hapus</a></div><br>
